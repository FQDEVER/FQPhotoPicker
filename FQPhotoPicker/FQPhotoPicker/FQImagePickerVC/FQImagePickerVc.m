...
-(FQImagePickerTitleBtn *)titleViewBtn
{
    if (!_titleViewBtn) {
        ...
        [button setImage:[UIImage imageNamed:@"btn-shareDetailTriathlon-isOpen-down" inBundle:MYBUNDLE compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
...
-(UIButton *)confirmBtn
{
    if (!_confirmBtn) {
        ...
        [_confirmBtn setBackgroundImage:[UIImage imageNamed:@"icon_social_confirm_normal_icon" inBundle:MYBUNDLE compatibleWithTraitCollection:nil] forState:UIControlStateDisabled];
        [_confirmBtn setBackgroundImage:[UIImage imageNamed:@"icon_social_confirm_select_icon" inBundle:MYBUNDLE compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
